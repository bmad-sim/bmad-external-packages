...
!
      ...
      INTERFACE LA_GGSVD3
       ...
       SUBROUTINE SGGSVD3_F95( A, B, ALPHA, BETA, K, L, U, V, Q, IWORK,  &
     &                        INFO )
          USE LA_PRECISION, ONLY: WP => SP
     ...
     &                                               Q(:,:)
       ...
       SUBROUTINE DGGSVD3_F95( A, B, ALPHA, BETA, K, L, U, V, Q, IWORK,  &
     &                        INFO )
          USE LA_PRECISION, ONLY: WP => DP
          INTEGER, INTENT(OUT), OPTIONAL :: INFO, K, L
          REAL(WP), INTENT(INOUT) :: A(:,:), B(:,:)
     ...
     &                                               Q(:,:)
       ...
       SUBROUTINE CGGSVD3_F95( A, B, ALPHA, BETA, K, L, U, V, Q, IWORK,  &
     &                        INFO )
          USE LA_PRECISION, ONLY: WP => SP
          INTEGER, INTENT(OUT), OPTIONAL :: INFO, K, L
     ...
     &                                                  Q(:,:)
       ...
       SUBROUTINE ZGGSVD3_F95( A, B, ALPHA, BETA, K, L, U, V, Q, IWORK,  &
     &                        INFO )
          USE LA_PRECISION, ONLY: WP => DP
          INTEGER, INTENT(OUT), OPTIONAL :: INFO, K, L
          COMPLEX(WP), INTENT(INOUT) :: A(:,:), B(:,:)
